...
void main()
{
	...
	measure("Среднее арифметическое элементов в дереве: ", tree, &Tree::Avg);
	measure("Колличество элементов в дереве: ", tree, &Tree::Count);
	measure("глубина в дереве: ", tree, &Tree::Depth);
